    ...
    switch($option){  
        ...
        case 1:
            ...
            if ($qtde_linhas > 0){
                ...
                $retorno['html'] = '';
                $montar = '';
                $montar .= "<h6 class='dropdown-header'>Necessário Atualizar!</h6>";
                foreach($data as $reg):                    
                    $montar .= "<a class='dropdown-item d-flex align-items-center' href='#'><div class='mr-3'>";
                    $montar .= "<div class='icon-circle bg-primary'><i class='fas fa-file-alt text-white'></i></div></div>";
                    ...
                    $montar .= "";
                endforeach; 
                $montar .= "<a class='dropdown-item text-center small text-gray-500' href='#'>Show All Alerts</a>";                   
                $retorno['html'] = $montar;
         
            } else {
                $retorno['dados'] = ''; // especifica o retorno como 0, será pego no main.js e tratado como retorno em function verIntervaloAtualizacao()
            }   
